...
.method private constructor <init>(Landroid/content/Context;Lcom/google/android/gms/analytics/f;Lcom/google/android/gms/analytics/ae;)V
    ...
    iput-object v1, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->Ay:Ljava/lang/Boolean;
    ...
    iput-object p1, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->mContext:Landroid/content/Context;
    ...
    invoke-static {p1}, Lcom/google/android/gms/analytics/g;->y(Landroid/content/Context;)V

    iget-object p1, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->mContext:Landroid/content/Context;

    invoke-static {p1}, Lcom/google/android/gms/analytics/ad;->y(Landroid/content/Context;)V

    iget-object p1, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->mContext:Landroid/content/Context;

    invoke-static {p1}, Lcom/google/android/gms/analytics/h;->y(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->AA:Ljava/util/Set;
...
.method private a(Lcom/google/android/gms/analytics/Tracker;)Lcom/google/android/gms/analytics/Tracker;
    ...
    invoke-virtual {p1, v1, v0}, Lcom/google/android/gms/analytics/Tracker;->set(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    iget-object p0, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->xM:Ljava/lang/String;

    if-eqz p0, :cond_1

    const-string v0, "&av"

    invoke-virtual {p1, v0, p0}, Lcom/google/android/gms/analytics/Tracker;->set(Ljava/lang/String;Ljava/lang/String;)V
...
.method static eD()Lcom/google/android/gms/analytics/GoogleAnalytics;
    ...
    :try_start_0
    sget-object v1, Lcom/google/android/gms/analytics/GoogleAnalytics;->AC:Lcom/google/android/gms/analytics/GoogleAnalytics;
...
.method private eE()V
    ...
    const-string p0, "Couldn\'t get ApplicationInfo to load gloabl config."
...
.method public static getInstance(Landroid/content/Context;)Lcom/google/android/gms/analytics/GoogleAnalytics;
    ...
    invoke-direct {v1, p0}, Lcom/google/android/gms/analytics/GoogleAnalytics;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcom/google/android/gms/analytics/GoogleAnalytics;->AC:Lcom/google/android/gms/analytics/GoogleAnalytics;

    :cond_0
    sget-object p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->AC:Lcom/google/android/gms/analytics/GoogleAnalytics;
...
.method a(Lcom/google/android/gms/analytics/v;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/analytics/GoogleAnalytics;->setDryRun(Z)V
...
.method b(Lcom/google/android/gms/analytics/GoogleAnalytics$a;)V
    ...
    iget-object p0, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->AA:Ljava/util/Set;
...
.method public dispatchLocalHits()V
    ...
    iget-object p0, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->Ax:Lcom/google/android/gms/analytics/ae;

    invoke-virtual {p0}, Lcom/google/android/gms/analytics/ae;->dispatchLocalHits()V
...
.method public enableAutoActivityReports(Landroid/app/Application;)V
    ...
    iput-boolean p1, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->AB:Z
...
.method public getAppOptOut()Z
    ...
    iget-object p0, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->Ay:Ljava/lang/Boolean;
...
.method public getLogger()Lcom/google/android/gms/analytics/Logger;
    ...
    iget-object p0, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->Az:Lcom/google/android/gms/analytics/Logger;
...
.method public isDryRunEnabled()Z
    ...
    iget-boolean p0, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->Aw:Z
...
.method public newTracker(I)Lcom/google/android/gms/analytics/Tracker;
    ...
    invoke-direct {v0, v2, p0, v1}, Lcom/google/android/gms/analytics/Tracker;-><init>(Ljava/lang/String;Lcom/google/android/gms/analytics/TrackerHandler;Landroid/content/Context;)V

    if-lez p1, :cond_0

    new-instance v1, Lcom/google/android/gms/analytics/ah;

    iget-object v2, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->mContext:Landroid/content/Context;

    invoke-direct {v1, v2}, Lcom/google/android/gms/analytics/ah;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1, p1}, Lcom/google/android/gms/analytics/ah;->w(I)Lcom/google/android/gms/analytics/i;

    move-result-object p1

    check-cast p1, Lcom/google/android/gms/analytics/ai;

    if-eqz p1, :cond_0

    invoke-virtual {v0, p1}, Lcom/google/android/gms/analytics/Tracker;->a(Lcom/google/android/gms/analytics/ai;)V
...
.method public setAppOptOut(Z)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->Ay:Ljava/lang/Boolean;

    iget-object p1, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->Ay:Ljava/lang/Boolean;
    ...
    iget-object p0, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->ye:Lcom/google/android/gms/analytics/f;

    invoke-interface {p0}, Lcom/google/android/gms/analytics/f;->dH()V
...
.method public setLocalDispatchPeriod(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/analytics/ae;->setLocalDispatchPeriod(I)V

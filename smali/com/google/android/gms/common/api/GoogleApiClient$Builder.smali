...
.field private IO:Landroidx/fragment/app/FragmentActivity;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IM:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/gms/common/api/GoogleApiClient$ConnectionCallbacks;Lcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;)V
    ...
    iget-object p1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IS:Ljava/util/Set;

    invoke-interface {p1, p2}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-string p1, "Must provide a connection failed listener"

    invoke-static {p3, p1}, Lcom/google/android/gms/common/internal/o;->b(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object p0, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IT:Ljava/util/Set;
...
.method private gl()Lcom/google/android/gms/common/api/GoogleApiClient;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IO:Landroidx/fragment/app/FragmentActivity;

    invoke-static {v0}, Lcom/google/android/gms/common/api/d;->a(Landroidx/fragment/app/FragmentActivity;)Lcom/google/android/gms/common/api/d;

    move-result-object v0

    iget v1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IP:I

    invoke-virtual {v0, v1}, Lcom/google/android/gms/common/api/d;->ak(I)Lcom/google/android/gms/common/api/GoogleApiClient;
    ...
    iget-object v4, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IH:Landroid/os/Looper;
    ...
    iget-object v6, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IN:Ljava/util/Map;

    iget-object v7, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IS:Ljava/util/Set;

    iget-object v8, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IT:Ljava/util/Set;

    iget v9, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IP:I

    iget v10, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IR:I

    move-object v2, v1

    invoke-direct/range {v2 .. v10}, Lcom/google/android/gms/common/api/b;-><init>(Landroid/content/Context;Landroid/os/Looper;Lcom/google/android/gms/common/internal/ClientSettings;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;II)V

    :cond_0
    iget v2, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IP:I

    iget-object p0, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IQ:Lcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;

    invoke-virtual {v0, v2, v1, p0}, Lcom/google/android/gms/common/api/d;->a(ILcom/google/android/gms/common/api/GoogleApiClient;Lcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;)V
...
.method public addApi(Lcom/google/android/gms/common/api/Api;)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    invoke-virtual {v3}, Lcom/google/android/gms/common/api/Scope;->gs()Ljava/lang/String;
...
.method public addApi(Lcom/google/android/gms/common/api/Api;Lcom/google/android/gms/common/api/Api$ApiOptions$HasOptions;)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IJ:Ljava/util/Set;
    ...
    invoke-virtual {v2}, Lcom/google/android/gms/common/api/Scope;->gs()Ljava/lang/String;
...
.method public build()Lcom/google/android/gms/common/api/GoogleApiClient;
    ...
    :cond_0
    new-instance v9, Lcom/google/android/gms/common/api/b;
...
.method public enableAutoManage(Landroidx/fragment/app/FragmentActivity;ILcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/o;->b(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroidx/fragment/app/FragmentActivity;

    iput-object p1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IO:Landroidx/fragment/app/FragmentActivity;
...
.method public setHandler(Landroid/os/Handler;)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->IH:Landroid/os/Looper;

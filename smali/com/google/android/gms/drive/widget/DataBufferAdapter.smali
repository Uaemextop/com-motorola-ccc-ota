...
.field private final RU:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field private final RV:Landroid/view/LayoutInflater;
...
.method public constructor <init>(Landroid/content/Context;IILjava/util/List;)V
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RW:Z

    iput-object p1, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->mContext:Landroid/content/Context;

    iput p2, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RS:I

    iput p2, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RR:I

    iput p3, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RT:I

    iput-object p4, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RU:Ljava/util/List;
    ...
    iput-object p1, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RV:Landroid/view/LayoutInflater;
...
.method private a(ILandroid/view/View;Landroid/view/ViewGroup;I)Landroid/view/View;
    ...
    iget-object p2, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RV:Landroid/view/LayoutInflater;
    ...
    :cond_0
    :try_start_0
    iget p3, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RT:I
    ...
    const-string p1, "DataBufferAdapter"

    const-string p2, "You must supply a resource ID for a TextView"

    invoke-static {p1, p0, p2}, Lcom/google/android/gms/drive/internal/v;->a(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;)V

    new-instance p1, Ljava/lang/IllegalStateException;

    const-string p2, "DataBufferAdapter requires the resource ID to be a TextView"
...
.method public append(Lcom/google/android/gms/common/data/DataBuffer;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RU:Ljava/util/List;

    invoke-interface {v0, p1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-boolean p1, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RW:Z
...
.method public clear()V
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RW:Z
...
.method public getContext()Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->mContext:Landroid/content/Context;
...
.method public getCount()I
    ...
    iget-object p0, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RU:Ljava/util/List;
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget v0, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RS:I
...
.method public getItem(I)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, p0}, Landroid/database/CursorIndexOutOfBoundsException;-><init>(II)V
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget v0, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RR:I
...
.method public setDropDownViewResource(I)V
    ...
    iput p1, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RS:I
...
.method public setNotifyOnChange(Z)V
    ...
    iput-boolean p1, p0, Lcom/google/android/gms/drive/widget/DataBufferAdapter;->RW:Z

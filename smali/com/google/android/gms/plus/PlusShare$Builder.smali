...
.field private als:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    iput-boolean p1, p0, Lcom/google/android/gms/plus/PlusShare$Builder;->alr:Z
...
.method public constructor <init>(Landroid/app/Activity;Lcom/google/android/gms/plus/PlusClient;)V
    ...
    :goto_0
    const-string v0, "PlusClient must not be null."

    invoke-static {p1, v0}, Lcom/google/android/gms/common/internal/o;->a(ZLjava/lang/Object;)V

    invoke-virtual {p2}, Lcom/google/android/gms/plus/PlusClient;->isConnected()Z

    move-result p1

    const-string v0, "PlusClient must be connected to create an interactive post."

    invoke-static {p1, v0}, Lcom/google/android/gms/common/internal/o;->a(ZLjava/lang/Object;)V

    invoke-virtual {p2}, Lcom/google/android/gms/plus/PlusClient;->mZ()Lcom/google/android/gms/plus/internal/e;

    move-result-object p1

    const-string v0, "https://www.googleapis.com/auth/plus.login"

    invoke-virtual {p1, v0}, Lcom/google/android/gms/plus/internal/e;->cg(Ljava/lang/String;)Z

    move-result p1

    const-string v0, "Must request PLUS_LOGIN scope in PlusClient to create an interactive post."
    ...
    :goto_1
    iget-object p0, p0, Lcom/google/android/gms/plus/PlusShare$Builder;->mIntent:Landroid/content/Intent;

    const-string p2, "com.google.android.apps.plus.SENDER_ID"
...
.method public getIntent()Landroid/content/Intent;
    ...
    invoke-static {v6, v7}, Lcom/google/android/gms/common/internal/o;->a(ZLjava/lang/Object;)V
    ...
    invoke-static {v7, v8}, Lcom/google/android/gms/common/internal/o;->a(ZLjava/lang/Object;)V
    ...
    invoke-static {v1, v5}, Lcom/google/android/gms/common/internal/o;->a(ZLjava/lang/Object;)V
    ...
    invoke-static {v1}, Lcom/google/android/gms/plus/PlusShare;->cd(Ljava/lang/String;)Z
    ...
    iget-object v5, p0, Lcom/google/android/gms/plus/PlusShare$Builder;->als:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Lcom/google/android/gms/plus/PlusShare$Builder;->als:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Lcom/google/android/gms/plus/PlusShare$Builder;->als:Ljava/util/ArrayList;
...
.method public setContentDeepLinkId(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)Lcom/google/android/gms/plus/PlusShare$Builder;
    ...
    iget-object p3, p0, Lcom/google/android/gms/plus/PlusShare$Builder;->mIntent:Landroid/content/Intent;

    const-string p4, "com.google.android.apps.plus.CONTENT_DEEP_LINK_ID"

    invoke-virtual {p3, p4, p1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    iget-object p1, p0, Lcom/google/android/gms/plus/PlusShare$Builder;->mIntent:Landroid/content/Intent;

    const-string p3, "com.google.android.apps.plus.CONTENT_DEEP_LINK_METADATA"
...
.method public setRecipients(Ljava/util/List;)Lcom/google/android/gms/plus/PlusShare$Builder;
    ...
    invoke-virtual {p1, v2, v3}, Landroid/content/Intent;->putStringArrayListExtra(Ljava/lang/String;Ljava/util/ArrayList;)Landroid/content/Intent;
